...
export class ItemController {
  ...
  @ApiResponse({status: 201, description: 'Item creado exitosamente', type: Item})
  ...
  @ApiResponse({status: 200, description: 'Lista de items obtenida exitosamente', type: [Item]})
  @ApiResponse({status: 403, description: 'Forbidden, Token is not valid or expired'})
  ...
  @ApiResponse({status: 200, description: 'Item encontrado exitosamente', type: Item})
  ...
  @ApiParam({ name: 'id', description: 'ID del item', example: 1 })
  @ApiResponse({status: 200, description: 'Item actualizado exitosamente', type: Item})
  @ApiResponse({status: 404, description: 'Item no encontrado'})
  @ApiResponse({status: 400, description: 'Bad Request'})
  @ApiResponse({status: 403, description: 'Forbidden, Token is not valid or expired'})
