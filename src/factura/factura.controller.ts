...
export class FacturaController {
  ...
  @ApiResponse({status: 201, description: 'Factura creada exitosamente', type: Factura})
  ...
  @ApiResponse({status: 200, description: 'Lista de facturas obtenida exitosamente', type: [Factura]})
  @ApiResponse({status: 403, description: 'Forbidden, Token is not valid or expired'})
  ...
  @ApiResponse({status: 200, description: 'Factura encontrada exitosamente', type: Factura})
  ...
  @ApiParam({ name: 'id', description: 'ID de la factura', example: 1 })
  @ApiResponse({status: 200, description: 'Factura actualizada exitosamente', type: Factura})
  @ApiResponse({status: 404, description: 'Factura no encontrada'})
  @ApiResponse({status: 400, description: 'Bad Request'})
  @ApiResponse({status: 403, description: 'Forbidden, Token is not valid or expired'})
